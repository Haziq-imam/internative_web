                        ...
                        <GlassCard className="p-8 md:p-12 rounded-[2.5rem] border-white/10 bg-[#0A051A]/80">
                            <div className="flex flex-col lg:flex-row gap-12">
                                <div className="flex-1 space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 pt-4">
                                        <div>
                                            <h5 className="text-white font-bold text-sm mb-3 underline decoration-primary underline-offset-4">Strategies:</h5>
                                            <ul className="space-y-2 text-sm text-text-muted font-medium">
                                                <li className="flex items-center gap-2 lg:whitespace-nowrap"><ArrowRight className="w-3 h-3 text-primary" /> ATM/ITM Calls (14-45 DTE)</li>
                                                <li className="flex items-center gap-2 lg:whitespace-nowrap"><ArrowRight className="w-3 h-3 text-primary" /> Debit Spreads (30+ DTE)</li>
                                                <li className="flex items-center gap-2 lg:whitespace-nowrap"><ArrowRight className="w-3 h-3 text-primary" /> Earnings Run-ups</li>
                                            </ul>
                                        </div>
                                        <div>
                                            <h5 className="text-white font-bold text-sm mb-3 underline decoration-primary underline-offset-4">Recent Wins:</h5>
