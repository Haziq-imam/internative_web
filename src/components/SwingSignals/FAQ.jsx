...
const FAQ = () => {
    ...
    const faqs = [
        ...
        { q: "What's the difference between swing trading and day trading?", a: "Day trading: Hold minutes/hours, constant monitoring, high stress, requires $25k+ (PDT). Swing trading: Hold 3-21 days, check 1-2x daily, lower stress, no PDT rule, perfect for part-time traders." },
        ...
        { q: "What happens if a swing trade goes against me over the weekend?", a: "We assess weekend gap risk for every signal. If high risk, we advise closing Friday. Crypto/futures trade 24/7 so no weekend gaps. If news breaks, we send emergency Sunday alerts." },
        { q: "Are swing trading signals suitable for beginners?", a: "Yes! Swing trading is MORE beginner-friendly than day trading. Less time pressure, less stress, better risk-reward, and more time to learn. We recommend beginners start with stock swings." },
        ...
        { q: "Can I use these signals in an IRA/401k?", a: "Yes, swing trading is perfect for retirement accounts since it doesn't violate day trading restrictions. Always check with your custodian, but generally, stock and basic options swings are permitted." }
    ];
