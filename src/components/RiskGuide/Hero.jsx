            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-bold mb-8 animate-fade-in">
                        <Shield className="w-4 h-4" /> Professional Risk Management Guide
                    </div>
                    <h1 className="text-5xl md:text-7xl font-black mb-8 leading-[1.05] tracking-tight">
                        Complete Guide to Managing <GradientText>Losses & Drawdowns</GradientText>
                    </h1>
                    <p className="text-xl text-text-secondary leading-relaxed font-medium mb-12">
                        Success depends entirely on risk management—not signal quality alone. Learn how to protect your capital and survive inevitable drawdowns to achieve sustainable trading success.
                    </p>
                </div>
            </div>
        </Section>
